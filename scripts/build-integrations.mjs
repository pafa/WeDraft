...
export async function buildIntegrations() {
  ...
  await writeFile(join(integrationDirectory, 'manifest.json'), JSON.stringify({ schemaVersion: 1, product: 'wedraft', version, dependencies: notices.inventory, files }, null, 2) + '\n');
